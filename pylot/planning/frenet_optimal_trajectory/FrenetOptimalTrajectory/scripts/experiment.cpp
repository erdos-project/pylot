...
int main() {
    ...
    for (int i = 0; i < 40; i++) {
        ...
        s0 = fot.best_frenet_path.s[1];
        c_d = fot.best_frenet_path.d[1];
        c_d_d = fot.best_frenet_path.d_d[1];
        c_d_dd = fot.best_frenet_path.d_dd[1];
        c_speed = fot.best_frenet_path.s_d[1];
    }
