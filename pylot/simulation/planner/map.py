...
class CarlaMap(object):
    def __init__(self, city, pixel_density=0.1643, node_density=50):
        ...
        self.map_image_center = np.asarray(
            self.map_image_center, dtype="int32")
    ...
    def get_walls_directed(self,
        ...
        if both_walls:
            ...
            final_walls = final_walls.union(
                self._grid.get_wall_target(node_target, target_ori,
                                           node_source))

            return final_walls
        else:

            return self._grid.get_wall_source(node_source, source_ori,
                                              node_target)
